...
ylabel('Wysokość [cm]');
ylim([min(y_zad(:,1))*0.75, max(y_zad(:,1))*1.6]); 
...
exportgraphics(gcf, "images/dmc_control_y_out_limit.pdf", "ContentType", "vector");
...
grid on;
set(gcf, 'position', [10, 10, 1000, 700]);
exportgraphics(gcf, "images/dmc_control_u_out_limit.pdf", "ContentType", "vector");
